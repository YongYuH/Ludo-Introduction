var html_text_object = {
    "en-us": {
        ...
        "hidden-xs form-text": "If you want to try LUDO, please wait Us<br>fews days and we will launch soon.<br>Leave Your Email so that we can notice<br>you immediately after we launch.",
        "visible-xs-block form-text": "If you want to try LUDO,<br>please wait us fews days<br>and we will launch soon.<br>Leave Your Email so that<br>we can notice you immediately<br>after we launch.<br><br>",
    ...
    "zh-tw": {
        ...
        "hidden-xs form-text": "如果想要玩玩看<span class=\"english\">Ludo</span>，<span class=\"english\">Ludo</span>網站將在近期上線，<br>在底下的表單留下<span class=\"english\">Email</span>，我們將會通知你最新資訊",
        "visible-xs-block form-text": "如果想要玩玩看<span class=\"english\">Ludo</span>，<br>=<span class=\"english\">Ludo</span>網站將在近期上線，<br>=在底下的表單留下<span class=\"english\">Email</span>，<br>=我們將會通知你最新資訊",
        "fill_in": "立即填寫表單",
